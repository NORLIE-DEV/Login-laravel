@include('partials.__header')
    <header class="max-w-lg mx-auto">
        <a href="#">
            <h1 class="text-4xl font-bold text-center text-white mb-5">{{$title}}</h1>
        </a>
    </header>
    <main class="bg-white max-w-lg mx-auto p-8 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2 text-center">Sign in to your account
                <a href="/login" class="text-purple-300 font-bold">Sign In</a>
            </p>
        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" name="name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400" value="{{old('name')}}">
                    @error('name')
